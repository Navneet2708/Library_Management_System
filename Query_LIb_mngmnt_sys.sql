...
----Task 8: Find total rental Income y category:
SELECT 
b.category,
SUM(b.rental_price),
Count(*)
...
SELECT * FROM members
WHERE reg_date >= current_date - Interval '180 days'; -----no record found so we'll create our own records to show

Insert into members(member_id, member_name, member_address, reg_date)
values
('118', 'Sam', '145 Main St', '2025-03-22'),
('119', 'Sunny', '112 Back St', '2025-03-26');
...
---Task 11: Create a table of books with rental price above a certian threshold 7USD:
...
---Taksk 12: Retrieve the list of books not yet returned:
SELECT 
